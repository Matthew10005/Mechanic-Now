...
public class MapsActivityTow extends FragmentActivity implements OnMapReadyCallback, LocationListener{
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("Mechanics").child("0777651665");
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    try {
                        ...
                        Toast.makeText(MapsActivityTow.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
